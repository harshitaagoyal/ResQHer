...
const PostSchema = new mongoose.Schema({
  ...
  location: { type: Object, required: true }, // Stores lat/lng or address object
  duration_of_abuse: { type: String, required: true },
  frequency_of_incidents: { type: String, required: true },
  preferred_contact_method: { type: [String], required: true }, // Array of strings
  current_situation: { type: String, required: true },
  culprit_description: { type: String, required: true },
  custom_text: { type: String, default: null }, // Optional field
