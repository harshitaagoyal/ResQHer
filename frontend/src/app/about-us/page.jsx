          ...
          <section>
            ...
            <ul className="space-y-6">
              <li className="text-[15px] leading-relaxed text-slate-600">
                <span className="font-bold text-slate-800">Trust Circle (Real-time SOS):</span> A mesh-network inspired feature that instantly syncs real-time GPS coordinates with trusted contacts via secure API integration during an emergency.
              </li>
              <li className="text-[15px] leading-relaxed text-slate-600">
                <span className="font-bold text-slate-800">Law Bot:</span> An AI-powered legal advisor trained on IPC (Indian Penal Code) sections to provide instant, simplified guidance on women’s rights and legal recourse.
              </li>
              <li className="text-[15px] leading-relaxed text-slate-600">
                <span className="font-bold text-slate-800">Therapy Bot:</span> A sentiment-aware AI companion designed to provide immediate emotional de-escalation and professional mental health routing during high-stress situations.
              </li>
              <li className="text-[15px] leading-relaxed text-slate-600">
                <span className="font-bold text-slate-800">Incident Reporting:</span> A sophisticated reporting system utilizing end-to-end encryption to securely store sensitive data and submit official reports.
              </li>
              <li className="text-[15px] leading-relaxed text-slate-600">
                <span className="font-bold text-slate-800">Discreet Fake Call:</span> A customizable UI simulation that triggers a realistic incoming call, providing a safe and unquestionable exit from socially uncomfortable or escalating situations.
              </li>
              <li className="text-[15px] leading-relaxed text-slate-600">
                <span className="font-bold text-slate-800">Nearby Help Mapping:</span> Geolocation-based integration that filters and maps verified hospitals, shelters, and police stations within an immediate radius.
              </li>
            </ul>
          </section>
