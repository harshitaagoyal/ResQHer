      ...
      <div className="max-w-5xl mx-auto pt-8">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="list-decimal pl-5 space-y-3 text-[15px] text-slate-600 dark:text-slate-300">
              <li>You may only view, copy and print portions of the Site Content for your own <span className="font-semibold text-slate-800 dark:text-white">informational, personal and non-commercial use</span>;</li>
